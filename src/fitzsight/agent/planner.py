...
def validate_plan(plan: AgentPlan) -> AgentPlan:
    """Validate planner output against the v0.13 multi-intent policy.
    ...
    if plan.plan_version != "0.13":
        raise PlanValidationError("Unsupported plan_version; expected '0.13'")
